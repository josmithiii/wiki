...
## Domain
Spectral audio signal processing — FFT-based analysis, modification, and
resynthesis of music and audio signals. Covers the DFT/DTFT/STFT, spectrum
analysis windows, overlap-add (OLA) and filter-bank summation (FBS) views of
the STFT, sinusoidal and sines-plus-noise (SMS) modeling, peak detection and
