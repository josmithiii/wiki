...
- Distilled in full: [[plate-reverb-parameter-estimation-challenge]] (model, tasks, metrics, rankings), [[state-space-models-as-modal-resonator-banks]] and [[modal-pole-harvesting-from-irs]]
